            ...
            <tbody>
                {appointments?.map((item) => (
                    <tr key={item._id}>
                        ...
                        >
                            <img
                                // Provide a fallback image if photo is missing or invalid
                                src={item.user?.photo || "https://via.placeholder.com/150"}
                                className="w-10 h-10 rounded-full"
                        ...
                        <td className="px-6 py-4">{formateDate(item.createdAt) || "No Date"}</td>
                    </tr>
                ))}
            </tbody>
        </table>
