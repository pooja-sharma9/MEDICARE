                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        ...
                        <div className="md:col-span-2 md:px-[30px]">
                            ...
                            border border-solid border-primaryColor`}>My Bookings</button>
                                ...
                                <button onClick={() => setTab('settings')} className={` ${tab === 'settings' && 'bg-primaryColor text-white font-normal'} py-2 px-5
                            rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}>Profile Settings</button>
                            </div>
